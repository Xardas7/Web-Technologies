...
<div class="container">
    ...
    <div class="row justify-content-center settings">
        ...
        <form class="col-6 p-5" action="{{ route('card.update',['id' => $card->id]) }}" method="POST">
            @csrf
            <div class="form-group row justify-content-center">
                ...
                onblur="this.placeholder = 'Card number'" required class="single-input" value="{{ $card->card_number }}">
                </div>
            </div>
            ...
            <div class="form-group row justify-content-center">
                ...
                <div class="input-group-icon col-10">
                    ...
                    <input class="single-input" name="exp_date" type="text" placeholder="Example: 2020/04"
                        onfocus="this.placeholder = ''" onblur="this.placeholder = 'Example: 2020/04'"  value="{{ $card->exp_date }}" maxlength="7" required>
                </div>
            </div>
            ...
            <div class="form-group row justify-content-center">
                ...
                <div class="input-group-icon col-10">
                    ...
                    <select class="form-control padding" name="type">
                        <option value="visa" {{ strtolower($card->type) == 'visa' ? 'selected' : '' }}>Visa
                        </option>
                        <option value="mastercard" {{ strtolower($card->type) == 'mastercard' ? 'selected' : '' }} >Mastercard
                        </option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group row justify-content-center">
                ...
                <div class="input-group-icon col-10">
                    ...
                    <input type="number" name="cvv" placeholder="cvv" onfocus="this.placeholder=''"
                        onblur="this.placeholder = 'cvv'" required class="single-input" min="100" max="999" value="{{ $card->cvv }}">
                </div>
            </div>
            ...
            <div class="form-group row justify-content-center p-1">
                ...
                <div class="input-group-icon col-10">
                    ...
                    <input type="text" name="name" placeholder="First Name" onfocus="this.placeholder = ''"
                        onblur="this.placeholder = 'First Name'" required class="single-input" value="{{ $card->user->name }}">
                </div>
            </div>
            ...
            <div class="form-group row justify-content-center">
                ...
                <div class="input-group-icon col-10">
                    ...
                    <input type="text" name="surname" placeholder="Last Name" onfocus="this.placeholder = ''"
                        onblur="this.placeholder = 'Last Name'" required class="single-input" value="{{ $card->user->surname }}">
                </div>
            </div>
