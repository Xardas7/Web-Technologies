            ...
            <div class="row align-items-center">
                <div class="col-md-6 col-12">
                    <div class="product-item d-flex align-items-center">
                        <img src="{{ Storage::exists($product->images->first()->path) ? asset("storage/".$product->images->first()->path) :  $product->images->first()->path}}" style="width:150px;" class="img-fluid" alt="" b>
                        <a href="/{{ $product->name }}">
                            <h6>{{ $product->name }}</h6>
                        </a>
                    </div>
